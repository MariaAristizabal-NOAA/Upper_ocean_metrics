...
print('The OHC from GOFS3.1 at (lon,lat) = (' + str(long)+','+str(latg)+') on '+ date_ini +' is ',\
      + OHC, ' kJ/m^2 \n')
...
MLD_temp_crit, MLT_temp_crit = MLD_temp_crit(dtemp,ref_depth,depth_model,\
                                             temp_model)
print('The mixed layer temperature (based on a temperatere criteria) from GOFS3.1 at (lon,lat) =  ('\
      + str(long)+','+str(latg)+') on '+ date_ini +' is ', MLT_temp_crit, ' degrees C \n')
...
print('The mixed layer temperature (based on a density criteria) from GOFS3.1 at (lon,lat) =  ('\
      + str(long)+','+str(latg)+') on '+ date_ini +' is ', MLT_dens_crit, ' degrees C \n')
...
print('The depth average temperature in the top 100 meters from GOFS3.1 at (lon,lat) =  ('\
      + str(long)+','+str(latg)+') on '+ date_ini +' is ', temp100, ' degrees C \n')
################################################################################
...
print('The potential energy anomaly in the top 100 meters from GOFS3.1 at (lon,lat) =  ('\
      + str(long)+','+str(latg)+') on '+ date_ini +' is ', PEA, ' J/m^3 \n')
